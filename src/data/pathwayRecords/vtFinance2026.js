...
const businessAdministrationSemesters = [
  {
    ...
    courses: [
      ...
      { code: "MTH 161", title: "PreCalculus I or higher", credits: 3, type: "Required", transferPriority: "VT Finance math preparation" },
  ...
  },
  {
    ...
    courses: [
      ...
      { code: "MTH 261", title: "Applied Calculus I or higher", credits: 3, type: "Required", transferPriority: "VT Finance math preparation" },
  ...
  },
  {
    ...
    courses: [
      { code: "ACC 211", title: "Principles of Accounting I", credits: 3, type: "Required", transferPriority: "VT Finance foundation" },
      { code: "BUS 224", title: "Business Statistics", credits: 3, type: "Required", transferPriority: "VT Business analytics preparation" },
  ...
  },
  {
    ...
    courses: [
      { code: "ACC 212", title: "Principles of Accounting II", credits: 3, type: "Required", transferPriority: "VT Finance foundation" },
...
export const vtFinance2026 = {
  ...
  sourceDocuments: [
    ...
    {
      label: "Virginia Tech Finance BS roadmaps",
      type: "VT finance roadmaps",
      note: "Reviewed roadmaps for Investment Management and CFA, Financial Accounting, Private Credit and Commercial Banking, and Corporate Financial Management. The NVCC Business Administration plan is the same foundation; concentration-specific courses are upper-division VT requirements."
    }
  ],
  gaa: vtFinanceGaa,
  transferRoadmap: {
    ...
    stronglyRecommended: [
      { vtCourse: "MATH 1025/1026", nvccCourse: "MTH 161 and MTH 261 or higher", title: "Calculus preparation for Pamplin finance" },
      { vtCourse: "BIT 2405/2406", nvccCourse: "BUS 224 and spreadsheet/business analytics coursework", title: "Business statistics and analytics preparation" },
      { vtCourse: "FIN 3134, FIN 3144, FIN 3154", nvccCourse: "Finance transfer preparation", title: "VT requires C or better in the core finance sequence after transfer" }
    ],
    recommended: [
      { vtCourse: "Investment Management and CFA option", nvccCourse: "Finance foundation", title: "Upper-division VT option includes courses such as Fixed Income Securities, Derivatives, Equity Securities, and Financial Modeling" },
      { vtCourse: "Financial Accounting option", nvccCourse: "Accounting foundation", title: "Upper-division VT option includes finance electives and ACIS electives such as Tax Impact or Cost Planning and Control" },
      { vtCourse: "Private Credit and Commercial Banking option", nvccCourse: "Finance foundation", title: "Upper-division VT option includes Credit Risk Analysis, Bank Management, and an FPCB elective" },
      { vtCourse: "Corporate Financial Management option", nvccCourse: "Finance foundation", title: "Upper-division VT option includes Python/SQL, Credit Risk Analysis, Asset Valuation, and Derivatives" },
      { vtCourse: "Pamplin+ Curriculum", nvccCourse: "BUS electives", title: "Choose NVCC business electives with an advisor to support transfer goals" }
    ]
  },
